...
The enforcement layer that governs what your agent does before it writes a line: discovery passes, blast radius limits, postmortem checks, migration gates, observability requirements. 
The checks a Staff Engineer runs automatically. 
